...
% Standard-Trading-Card: 63,5 x 88,9 mm
\usepackage[
  paperwidth=63.5mm,
  paperheight=88.9mm,
  margin=0mm
...
% -----------------------------------------------------------------------------
% DATEN DER KARTE
% Nur diesen Bereich für einen anderen Piloten ändern.
% -----------------------------------------------------------------------------
\newcommand{\PilotName}{Plissken}
\newcommand{\PilotStatus}{AKTIV}
\newcommand{\PilotRole}{MECHWARRIOR}
\newcommand{\PilotImage}{Bilder/plissken.png}

\newcommand{\Gunnery}{3}
\newcommand{\Piloting}{5}
\newcommand{\SPASlots}{0 / 2}

\newcommand{\AbilityOneName}{RANGE MASTER (LONG)}
\newcommand{\AbilityOneText}{The gunner for this unit specializes in attacks at long range: apply a -1 Target Number modifier for attacks at long range, but a +2 modifier for any attack made in short range.}

\newcommand{\AbilityTwoName}{SPEED DEMON}
\newcommand{\AbilityTwoText}{A pilot with the Speed Demon SPA adds +2 inches to the unit's ground movement and +3 inches to the unit's sprint value, without increasing the TMM.}

\newcommand{\AssignedUnit}{WARHAMMER}
\newcommand{\AssignedVariant}{WHM-7M}
% -----------------------------------------------------------------------------

% Farben, angelehnt an die Override-Oberfläche
...
\newcommand{\AbilityBox}[5]{%
  ...
  \node[anchor=north west, text=TextMain,
    ...
    at (10.6,{#2-1.0}) {#4};
  \node[anchor=north west, text width=47.7mm, align=left,
        text=TextMuted, font=\fontsize{4.35}{5.05}\selectfont]
    at (10.6,{#2-4.8}) {#5};
}

\begin{document}
\begin{tikzpicture}[x=1mm,y=1mm]
  % Kartenhintergrund und Außenrand
  ...
  % Profilbild mit Platzhalter, wenn die Datei noch fehlt
  ...
  \begin{scope}
    ...
    \IfFileExists{\PilotImage}{%
      ...
      \node[text=TextMuted, align=center,
        ...
        at (12.2,78.45) {PROFILBILD\\EINFÜGEN};
    }
  \end{scope}
  ...
  \AbilityBox{39.5}{52.8}{1}{\AbilityOneName}{\AbilityOneText}
  \AbilityBox{24.4}{37.7}{2}{\AbilityTwoName}{\AbilityTwoText}
